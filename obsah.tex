...
Dále se se poèítání podle pøíody inspirovalo procesy vznikajícími ve spoleènosti, v usuzování jedincù apod. My se zde budeme zabývat hloubìji pouze fylogenezí, nebo» 
...
evoluèních algoritmù, jako jsou napøíklad genetické programování :
\begin{itemize}
	\item 
\end{itemize}
