 ...
 * This module contains the third design method based on the Cuckoo
 * hashing.
 */
...
public class Cuckoo extends GPProblem implements SimpleProblemForm
{
    ...
    // This is where you can change the CuckooLoop for the experiments
    ...
    public void evaluate(final EvolutionState state,
		...
		long index1, index2;
	        int[] octets;
                ...
                // This is the standard CUCKOO INSERT function as defined
                // in the thesis. It consists of 2 tables and two ASTs for
                // a single individual.
	    ...
	    f.setStandardizedFitness(state, (double) (maximumLoad - load) /*aka collisions*/ / maximumLoad);
	    f.hits = load;
	    ind.evaluated = true;
	}
    }
