...
\subsection{Merkle-Damgardovo konstrukèní schéma}
V oblasti kryptografických ha¹ovacích funkcí se Merkle-Damgardovo schéma \cite{merkle0} jedním ze základních
...
Jedná se o obecné schéma pro výstavbu ha¹ovacích funkcí odolných proti kolizím z jednosmìrných
kompresních funkcí. Schéma se skládá z $n$ blokù pevné délky reprezentující vstupní zprávu.
K nim korespondují jednosmìrné kompresní funkce. Ka¾dá kompresní má na vstupu blok vstupních dat,
...
zarovnání. Poslední finalizaèní komponenta je volitelná. Schéma blí¾e ilustruje obrázek 
...
Dodelat proc, a v jakych hasovaci funkcich se pouzivaji.
Strucne uvest dalsi konstrukcni schemata.
 
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{fig/merkle_damgard}
	\caption{Obecné Merkle-Damgardovo schéma pro $n$ blokù.}
...
Merkle-Damgardovo schéma popsané v kapitole \ref{sec:hashing}. Krátce popí¹eme zmìny v na¹em
...
Nejprve se tedy budeme zkoumat výsledky, jaké poskytuje námi navr¾ené øe¹ení z kapitoly
 \ref{sec:solution_design}. Námi navr¾ený algoritmus porovnáme s dvìmi variantami náhodného prohledávání.
 Prvni varianta bude náhodné prohledávání bez pou¾ití elitismu, druhá s elitismem. Do grafu zahrneme i jednu
 variantu èlovekem vytvoøené obecné ha¹ovací funkce, konkrétnì ha¹ovací funkci \textit{Murmurhash3}. 

\section{Ha¹ování s Merkle-Damgardovou konstrukcí}

\section{Kukaèèní ha¹ování}
