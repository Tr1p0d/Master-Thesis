...
kompresních funkcí na míru konkrétnímu oktetu IP adresy. 
...
TODO include altered MD picture. 
...
\begin{figure}[!h]
	...
	\end{tikzpicture}
	\caption{Nejlep¹í jedinci boxplot nad setem 2.}
\end{figure}
%%%%%%%%%%%%% IPHASH BOXPLOT %%%%%%%%%%%%%%%
...
\label{fig:basicPopulationDepth}
\end{figure}
