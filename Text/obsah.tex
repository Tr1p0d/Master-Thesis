...
\textit{SMHasher} []. Oficiální referenèní implementace funkce \textit{FarmHash} je mo¾né získat z repozitáøe na
...
jsou pøevzaty z ji¾ døíve zmínìného balíku \textit{SMHasher} []. 
